  ...
  const integrations = [
    {
      ...
      description: "Легко импортируйте и связывайте ваши страницы Notion в граф знаний."
    },
    {
      name: "Evernote",
      ...
      description: "Конвертируйте ваши заметки Evernote в связанные узлы знаний одним кликом."
    },
    {
      ...
      description: "Извлекайте контент напрямую из ваших Google Документов, сохраняя форматирование и ссылки."
    },
    {
      name: "Obsidian",
      ...
      description: "Импортируйте ваше хранилище Obsidian и сохраните все внутренние ссылки в графе."
    },
    {
      name: "Roam Research",
      ...
      description: "Преобразуйте вашу базу данных Roam в интерактивную нейронную сеть."
    },
    {
      name: "ChatGPT",
      ...
      description: "Интегрируйте ваши разговоры с ChatGPT и сохраняйте важные инсайты прямо в граф."
    },
    {
      name: "Perplexity",
      ...
      description: "Сохраняйте результаты поиска и инсайты на основе ИИ из Perplexity в вашу базу знаний."
    },
    {
      name: "Claude",
      ...
      description: "Превращайте ваши разговоры с Claude ИИ в структурированные узлы знаний с семантическими связями."
    },
    {
      name: "Groq",
      ...
      description: "Импортируйте высокопроизводительные ответы ИИ от Groq и организуйте их во втором мозге."
    },
    {
      name: "Apple Заметки",
      ...
      description: "Синхронизируйте ваши Apple Заметки между устройствами и интегрируйте их в граф знаний."
    }
  ];
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center p-1.5 bg-muted rounded-xl mb-4">
            <div className="bg-background px-4 py-2 rounded-lg shadow-sm">
              ...
              <span className="font-semibold">Бесшовные Интеграции</span>
            </div>
          </div>
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Подключайтесь к вашим любимым инструментам</h2>
          <p className="text-muted-foreground mt-3 max-w-2xl mx-auto">
            Импортируйте ваши существующие знания с популярных платформ и преобразуйте их в интерактивную нейронную сеть.
          </p>
        </div>
