...
export const DesignSection = ({
  ...
  const templateCategories = [{
    ...
    templates: ["Создатель Курсов", "Заметки к Книгам", "Интерактивная Презентация", "Мозговой Штурм", "Сценарий Видео", "Планирование Подкаста", "Портфолио Дизайнера", "Творческое Письмо"]
  }, {
    title: "Бизнес Инструменты",
    templates: ["Маркетинговая Кампания", "Бизнес Предложение", "Шаблон Контракта", "Запуск Продукта", "Панель Продаж", "Управление Клиентами", "Заметки Встреч", "Бизнес План"]
  }, {
    title: "Исследования и Стратегия",
    templates: ["Научная Работа", "Решение Проблем", "Контент Календарь", "Стратегия Соцсетей", "Академические Заметки", "Обзор Литературы", "Анализ Конкурентов", "Исследование Рынка"]
  }, {
    title: "Личное Развитие",
    templates: ["Трекер Привычек", "Постановка Целей", "Дневник Обучения", "Список Чтения", "Планировщик Путешествий", "Фитнес Трекер", "Система Продуктивности", "Дневник Рефлексии"]
  }];
  ...
  return <AnimatedTransition show={show} animation="slide-up" duration={600}>
      <div className="py-16 md:py-24">
        <div className="flex flex-col items-center text-center gap-2 mb-12">
          <h2 className="text-4xl font-bold text-blue-600 md:text-8xl">Дизайн</h2>
          <p className="text-foreground max-w-3xl text-xl md:text-2xl mt-2">Выберите из более чем 200 готовых шаблонов, адаптированных под ваши потребности.</p>
        </div>
