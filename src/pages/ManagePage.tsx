...
const ManagePage = () => {
  ...
  const [libraryTitle, setLibraryTitle] = useState('Библиотека Мозга');
    ...
    <div className="max-w-full mx-auto h-screen pt-24 pb-6">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Редактировать Название Библиотеки</DialogTitle>
          </DialogHeader>
          <div className="py-4">
            <Input
              value={tempTitle}
              onChange={(e) => setTempTitle(e.target.value)}
              className="w-full"
              placeholder="Введите название для вашей библиотеки"
              autoFocus
            />
          </div>
          <DialogFooter>
            ...
            <Button onClick={handleDialogSave}>Сохранить</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
